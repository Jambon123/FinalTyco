...
GTCEuStartupEvents.materialModification(event => {
    TagPrefix.block.setIgnored(GTMaterialRegistry.getMaterial("manasteel"), AEBlocks.SKY_STONE_BLOCK) 
})
...
GTCEuStartupEvents.materialModification(event => {
    ...
    TagPrefix.gem.setIgnored(GTMaterialRegistry.getMaterial("mana_diamond"))       
    TagPrefix.block.setIgnored(GTMaterialRegistry.getMaterial("mana_diamond"))     
    TagPrefix.gem.setIgnored(GTMaterialRegistry.getMaterial("mana_pearl"))
    TagPrefix.gem.setIgnored(GTMaterialRegistry.getMaterial("mana_quartz"))
    TagPrefix.block.setIgnored(GTMaterialRegistry.getMaterial("mana_quartz"))

    TagPrefix.ingot.setIgnored(GTMaterialRegistry.getMaterial("terrasteel"))
    TagPrefix.nugget.setIgnored(GTMaterialRegistry.getMaterial("terrasteel"))
    TagPrefix.block.setIgnored(GTMaterialRegistry.getMaterial("terrasteel"))
})
